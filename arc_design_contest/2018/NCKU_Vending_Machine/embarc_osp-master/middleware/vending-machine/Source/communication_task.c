...
#define DFL_ARC4                -1
#define DFL_AUTH_MODE           MBEDTLS_SSL_VERIFY_OPTIONAL
...
while(1)
{
    ...
    send_request:
        ...
        strncpy( (char *) buf + len, GET_REQUEST_END, MBEDTLS_SSL_MAX_CONTENT_LEN - len );
        len += tail_len;
...
//  return( ret );
    ...
    // for FREERTOS, it doesn't allow the task to exit itself
    EMBARC_PRINTF("\r\n.........................................\r\n");
