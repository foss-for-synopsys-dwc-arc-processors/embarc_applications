...
/* Variables */
extern uint16_t this_samples;
extern double this_samplingFrequency;
extern double *this_vReal;
extern double *this_vImag;
extern uint8_t this_power;
...
void ComplexToMagnitude_1(void);
