...
// 定义数据点
uint8_t Aquarius_Oxy_Freq;    //水族箱增氧频率，可写；0.常开 1.间隔15分钟 2.间隔30分钟 3.间隔45分钟 4.间隔1小时 5.间隔两小时 6.常关
uint8_t Aquarius_Feed_Freq;   //水族箱投食频率，可写；0.一天一次 1.一天两次 2.一天三次 3.一天四次 4.一天五次 5.关闭自动投食
uint8_t Aquarius_Temp;        //水族箱温度，数值，只读
uint8_t Aquarius_Feed_Amount; //水族箱投食数量, 可写，0-100
uint8_t Aquarius_Light;       //水族箱灯光开关, 可写，布尔值
