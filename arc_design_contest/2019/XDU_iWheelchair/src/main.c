...
void timer0_isr(void *ptr) {
  ...
  /**channel_0 is front distance sensor sampling;
  *channel_1 is back distance sensor sampling; 
  *channel_2 is tilt switch sensor sampling*/
