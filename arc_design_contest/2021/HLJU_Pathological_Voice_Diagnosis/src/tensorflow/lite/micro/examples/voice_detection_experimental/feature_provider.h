...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_VOICE_DETECTION_EXPERIMENTAL_IMAGE_PROVIDER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_VOICE_DETECTION_EXPERIMENTAL_IMAGE_PROVIDER_H_
...
TfLiteStatus GetFeature(tflite::ErrorReporter* error_reporter, int8_t* input_features, int image_width,
                      int image_height, int channels, int8_t* image_data);

#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_VOICE_DETECTION_EXPERIMENTAL_IMAGE_PROVIDER_H_
