 ...
 */
constexpr int kNumCols = 100;
constexpr int kNumRows = 4;

/*
 *constexpr int kNumChannels = 1;
 *constexpr int kMaxImageSize = 400;
 */
constexpr int kMaxImageSize = kNumCols * kNumRows;


constexpr int kCategoryCount = 2;
constexpr int kPtIndex = 1;
constexpr int kCoIndex = 0;
...
#endif
/*
 *TENSORFLOW_LITE_MICRO_EXAMPLES_PERSON_DETECTION_EXPERIMENTAL_MODEL_SETTINGS_H_
 */
