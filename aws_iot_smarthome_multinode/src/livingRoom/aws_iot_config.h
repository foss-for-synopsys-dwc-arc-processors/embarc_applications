...
#define AWS_IOT_MQTT_CLIENT_ID         "csdk-nd_lvr1" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "livingRoom" ///< Thing Name of the Shadow this device is associated with
